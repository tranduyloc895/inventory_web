...
async def list_orders(
    ...
    return await order_service.get_orders(db, mysql_db, user_id=user_id)
...
async def create_order(
    ...
    return await order_service.create_order(db, mysql_db, data, current_user.id)
...
async def update_order_status(
    ...
    return await order_service.update_order_status(db, mysql_db, order_id, status, current_user)
